...
parser.add_argument('--save_interval', default=160, type=int,
        ...
        for epoch in range(num_epochs):
            ...
            for datum in data_loader:
                ...
                if iteration % 10 == 0:
                    ...
                    writer.add_scalar('Train/Loss_B', losses['B'], iteration)
                    writer.add_scalar('Train/Loss_C', losses['C'], iteration)
            ...
            if args.validation_epoch > 0:
                if epoch % args.validation_epoch == 0 and epoch > 0:
                    val_results = compute_validation_map(epoch, iteration, yolact_net, val_dataset, log if args.log else None)

                    for key in val_results.keys():
                        for subKey in val_results[key].keys():
                            writer.add_scalar(f"Val/{key}/{subKey}", val_results[key][subKey], iteration)
